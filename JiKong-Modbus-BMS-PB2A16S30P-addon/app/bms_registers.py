...
BMS_MAP = {
    ...
    0x01: {
        ...
        36:  ("浮充电压", "V", TYPE_U32, conv_div1000),
        40:  ("自动关机电压", "V", TYPE_U32, conv_div1000),
        44:  ("持续充电电流", "A", TYPE_U32, conv_div1000),
        48:  ("充电过流保护延迟", "S", TYPE_U32, conv_none),
        52:  ("充电过流保护解除", "S", TYPE_U32, conv_none),
        56:  ("持续放电电流", "A", TYPE_U32, conv_div1000),
        60:  ("放电过流保护延迟", "S", TYPE_U32, conv_none),
        64:  ("放电过流保护解除", "S", TYPE_U32, conv_none),
        68:  ("短路保护解除", "S", TYPE_U32, conv_none),
        72:  ("最大均衡电流", "mA", TYPE_U32, conv_none),
        76:  ("充电过温保护", "°C", TYPE_I32, conv_div10),
        80:  ("充电过温恢复", "°C", TYPE_I32, conv_div10),
        84:  ("放电过温保护", "°C", TYPE_I32, conv_div10),
        88:  ("放电过温恢复", "°C", TYPE_I32, conv_div10),
        92:  ("充电低温保护", "°C", TYPE_I32, conv_div10),
        96:  ("充电低温恢复", "°C", TYPE_I32, conv_div10),
...
#        148: ("Set: Wire Res 3", "uΩ", TYPE_U32, conv_none),
    ...
    0x02: {
        ...
        0:  ("01單體電壓", "V", TYPE_U16, conv_div1000),
        2:  ("02單體電壓", "V", TYPE_U16, conv_div1000),
        4:  ("03單體電壓", "V", TYPE_U16, conv_div1000),
        6:  ("04單體電壓", "V", TYPE_U16, conv_div1000),
        8:  ("05單體電壓", "V", TYPE_U16, conv_div1000),
        10: ("06單體電壓", "V", TYPE_U16, conv_div1000),
        12: ("07單體電壓", "V", TYPE_U16, conv_div1000),
        14: ("08單體電壓", "V", TYPE_U16, conv_div1000),
        16: ("09單體電壓", "V", TYPE_U16, conv_div1000),
        18: ("10單體電壓", "V", TYPE_U16, conv_div1000),
        20: ("11單體電壓", "V", TYPE_U16, conv_div1000),
        22: ("12單體電壓", "V", TYPE_U16, conv_div1000),
        24: ("13單體電壓", "V", TYPE_U16, conv_div1000),
        26: ("14單體電壓", "V", TYPE_U16, conv_div1000),
        ...
        70: ("最大压差", "V", TYPE_U16, conv_div1000),
        72: ("最大电压", "#", TYPE_U8, conv_plus1),
        73: ("最小电压", "#", TYPE_U8, conv_plus1), # Offset 72 is U8(Max), next byte is Min
...
#        80: ("Wire Res 3", "mΩ", TYPE_U16, conv_none),
        ...
        144: ("电池总电压", "V", TYPE_U32, conv_div1000),
