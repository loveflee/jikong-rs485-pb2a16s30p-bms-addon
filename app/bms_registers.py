...
# [新增] 專門給 HA binary_sensor 用的標準狀態轉換
...
BMS_MAP = {
    ...
    0x01: {
        ...
        112: ("充电开关", "Bit", TYPE_U32, conv_onoff, HA_BINARY, "mdi:battery-charging", "charge_switch"),
        116: ("放电开关", "Bit", TYPE_U32, conv_onoff, HA_BINARY, "mdi:battery-arrow-down", "discharge_switch"),
        120: ("均衡开关", "Bit", TYPE_U32, conv_onoff, HA_BINARY, "mdi:scale-balance", "balance_switch"),
...
#       186: ("用户层报警", "Hex", TYPE_U16, conv_hex , HA_BINARY, "mdi:switch", "user_alarms"),
        ...
        192: ("充电状态", None, TYPE_U8, conv_onoff, HA_BINARY, "mdi:battery-charging", "charge_status"),
        # 原廠定義 193 (Hex 0xC1): Discharge (UINT8)
        193: ("放电状态", None, TYPE_U8, conv_onoff, HA_BINARY, "mdi:battery-arrow-down-outline", "discharge_status"),
